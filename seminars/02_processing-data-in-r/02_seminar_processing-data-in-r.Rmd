...
subtitle: "R Workshop 2 - Processing Data in R"
output: 
  html_document:
    css: "../../style.css"
    toc: true
...
This week we will look at working with functions and using R to work with data saved to an external .csv file. This is a very common use case for R. After reading the background on the content in this file, move on to completing the exercises and questions in **seminars/02_processing-data-in-r/questions.Rmd**.
