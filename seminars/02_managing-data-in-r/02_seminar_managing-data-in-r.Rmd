...
Load the data called "seminar_two_data.csv" into this R session as follows. To do this, create an R code chunk and copy and paste the following code into it.
