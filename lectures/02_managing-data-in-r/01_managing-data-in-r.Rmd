...
You need to be able to **uniquely identify** files within file paths. They either need unique names in a given location, or can have the same name in a different location.
...
*The last option is best for reproducibility.*
