...
subtitle: "R Workshop 2 - Processing Data in R Answers"
output: 
  html_document:
    css: "../../style.css"
    toc: true
...
```{r exercise-7-v2-answer, eval = FALSE}
cleaned_data_three <- cleaned_data_two %>% 
  filter(!is.na(DV))
