...
Click **New Project** and then set a **Directory Name** for your folder (e.g. "r_lesson_one"). This will create a folder wherever you have it set to in **Create project as a subdirectory of:**. Below, this is just on my Desktop, so this will make a folder called "r_lesson_one" on my Desktop. Inside this folder, there'll be a file with the folder name ending in **.Rproj**.
